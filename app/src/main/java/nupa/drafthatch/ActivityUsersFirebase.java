...
public class ActivityUsersFirebase extends AppCompatActivity {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if (firebaseAuth.getCurrentUser() == null) {
                    Intent intent = new Intent(ActivityUsersFirebase.this, ActivityLoginEmailPass.class);
    ...
    private void getUsers() {
        mDatabase.child("users").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Toast.makeText(ActivityUsersFirebase.this, "Total Users : " + dataSnapshot.getChildrenCount(), Toast.LENGTH_SHORT).show();
                entries.clear();
                while (items.hasNext()) {
                ...
                recyclerview.setAdapter(new RecUsersAdapter(ActivityUsersFirebase.this, entries));
