...
public class download_image extends ActionBarActivity implements View.OnClickListener{
    ...
    private void getImage() {
        ...
        class GetImage extends AsyncTask<String,Void,Bitmap>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(download_image.this, "Loading Profile...", null,true,true);
            }
