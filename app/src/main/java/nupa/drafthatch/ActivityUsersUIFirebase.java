...
public class ActivityUsersUIFirebase extends AppCompatActivity {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if (firebaseAuth.getCurrentUser() == null) {
                    Intent logIntent = new Intent(ActivityUsersUIFirebase.this, ActivityLoginEmailPass.class);
                    ...
                    FirebaseRecyclerAdapter<User, UserViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<User, UserViewHolder>(
                        ...
                        protected void populateViewHolder(final UserViewHolder holder, User model, int position) {
                            ...
                            if (!model.image.equals("default"))
                                Picasso.with(ActivityUsersUIFirebase.this).load(model.image).into(holder.imgProfile);
                        }
                    };
